...
public class BinaryTreeMaxDistanceTest extends BaseTest {

    private final BinaryTreeMaxDistance binaryTreeMaxDistance = new BinaryTreeMaxDistance();

    @Override
    public void runTest() {
        TreeNode head = generateRandomBST(5, 100);
        if (maxDistance1(head) != binaryTreeMaxDistance.getMaxDistance(head)) {
